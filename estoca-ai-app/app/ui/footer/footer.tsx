...
export default function Footer() {
  ...
  const fetchProdutosPaginados = async (
    ...
    try {
      const token = localStorage.getItem("token") || "";
      const url = `http://localhost:8080/produtos/paginado?page=${pageNumber}&size=${PAGE_SIZE}&search=${encodeURIComponent(
        search
      )}`;
        ...
        >
          ...
          >
            ...
            {produtos.length === 0 && loading ? (
              ...
              <div className="flex flex-col max-h-[50vh] overflow-y-auto" ref={produtosContainerRef}>
                ...
                {/* Se estiver carregando mais itens (páginas seguintes), exibe abaixo: */}
